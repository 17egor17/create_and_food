...
public class FermentationFluidBarrelRecipeCategory implements IRecipeCategory<FermentationFluidBarrelRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(CreateAndFood.MOD_ID, "fermentation_fluid");
    ...
    public static final RecipeType<FermentationFluidBarrelRecipe> FERMENTATION_FLUID_TYPE =
            new RecipeType<>(UID, FermentationFluidBarrelRecipe.class);

    public FermentationFluidBarrelRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public void draw(FermentationFluidBarrelRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
    ...
    protected void drawTimeSecond(FermentationFluidBarrelRecipe recipe, PoseStack poseStack, int x, int y) {
    ...
    @SuppressWarnings("removal")
    @Override
    public Class<? extends FermentationFluidBarrelRecipe> getRecipeClass() {
        return FermentationFluidBarrelRecipe.class;
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, FermentationFluidBarrelRecipe recipe, IFocusGroup focuses) {
