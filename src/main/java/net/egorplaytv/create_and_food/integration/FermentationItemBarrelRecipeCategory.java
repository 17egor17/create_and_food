...
public class FermentationItemBarrelRecipeCategory implements IRecipeCategory<FermentationItemBarrelRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(CreateAndFood.MOD_ID, "fermentation_item");
    ...
    public static final RecipeType<FermentationItemBarrelRecipe> FERMENTATION_ITEM_TYPE =
            new RecipeType<>(UID, FermentationItemBarrelRecipe.class);

    public FermentationItemBarrelRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public void draw(FermentationItemBarrelRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
    ...
    protected void drawTimeSecond(FermentationItemBarrelRecipe recipe, PoseStack poseStack, int x, int y) {
    ...
    @SuppressWarnings("removal")
    @Override
    public Class<? extends FermentationItemBarrelRecipe> getRecipeClass() {
        return FermentationItemBarrelRecipe.class;
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, FermentationItemBarrelRecipe recipe, IFocusGroup focuses) {
