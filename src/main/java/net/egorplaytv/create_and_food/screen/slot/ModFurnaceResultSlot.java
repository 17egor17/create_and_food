...
public class ModFurnaceResultSlot extends SlotItemHandler {
    private final Player player;
    private int removeCount;

    public ModFurnaceResultSlot(Player pPlayer, IItemHandler itemHandler, int index, int xPosition, int yPosition) {
