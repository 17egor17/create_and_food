...
public class ModFoods {
    public static final FoodProperties PIZZA = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.3F).build();
    ...
    public static final FoodProperties BERRYS = (new FoodProperties.Builder()).nutrition(5).saturationMod(0.6F).build();
