...
public class DescriptionTweenItem extends Item {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltip, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasControlDown()) {
            pTooltip.add(new TranslatableComponent("tooltip.create_and_food.control_down"));
            pTooltip.add(new TextComponent(" "));
            pTooltip.add(new TranslatableComponent("tooltip.create_and_food.desc_item." + ID + ".control_desc"));
        } else {
            pTooltip.add(new TranslatableComponent("tooltip.create_and_food.control"));
        }
    }
}
