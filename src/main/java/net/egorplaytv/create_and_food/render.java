...
public class render {
    public render(FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(ModFluids.APPLE_VINEGAR.get(), RenderType.translucent());
        ...
        ItemBlockRenderTypes.setRenderLayer(ModFluids.WHITE_CHOCOLATE.get(), RenderType.translucent());
        ...
        ItemBlockRenderTypes.setRenderLayer(ModFluids.COCOA_OIL.get(), RenderType.translucent());
