...
public class WildBlueberryBlock extends WildBerryBushBlock {
    public WildBlueberryBlock(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public ItemStack getCloneItemStack(BlockState state, HitResult target, BlockGetter level, BlockPos pos, Player player) {
        return ModItems.BLUEBERRY_SAPLING.get().getDefaultInstance();
    }
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit) {
        ...
        if (!flag && pPlayer.getItemInHand(pHand).is(Items.BONE_MEAL)) {
            ...
            ItemStack setBranch = ModItems.BLUEBERRY_SAPLING.get().getDefaultInstance();
            ...
            ItemStack setBerries = ModItems.BLUEBERRY.get().getDefaultInstance();
