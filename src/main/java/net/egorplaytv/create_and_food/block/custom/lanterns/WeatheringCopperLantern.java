...
public interface WeatheringCopperLantern extends ChangeOverTimeBlock<WeatheringCopperLantern.WeatherState> {
    Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> {
        return ImmutableBiMap.<Block, Block>builder()
                .put(GLOWING_BRASS_COPPER_LANTERN.get(), GLOWING_BRASS_EXPOSED_COPPER_LANTERN.get())
                .put(GLOWING_BRASS_EXPOSED_COPPER_LANTERN.get(), GLOWING_BRASS_WEATHERED_COPPER_LANTERN.get())
                .put(GLOWING_BRASS_WEATHERED_COPPER_LANTERN.get(), GLOWING_BRASS_OXIDIZED_COPPER_LANTERN.get())
                .build();
    });
