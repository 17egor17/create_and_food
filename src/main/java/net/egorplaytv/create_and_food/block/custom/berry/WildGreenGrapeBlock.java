...
public class WildGreenGrapeBlock extends WildBerryBushBlock {
    public WildGreenGrapeBlock(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public ItemStack getCloneItemStack(BlockState state, HitResult target, BlockGetter level, BlockPos pos, Player player) {
        return ModItems.GREEN_GRAPE.get().getDefaultInstance();
    }
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit) {
        ...
        if (!flag && pPlayer.getItemInHand(pHand).is(Items.BONE_MEAL)) {
            ...
            ItemStack setBranch = ModItems.GREEN_GRAPE_SAPLING.get().getDefaultInstance();
            ...
            ItemStack setBerries = ModItems.GREEN_GRAPE.get().getDefaultInstance();
