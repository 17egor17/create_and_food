...
import net.egorplaytv.create_and_food.block.custom.BirchCuttingBoardBlock;
import net.egorplaytv.create_and_food.block.entity.custom.BirchCuttingBoardBlockEntity;
...
public class BirchCuttingBoardRenderer implements BlockEntityRenderer<BirchCuttingBoardBlockEntity> {
    public BirchCuttingBoardRenderer(BlockEntityRendererProvider.Context context){
    }

    public void render(BirchCuttingBoardBlockEntity cuttingBoardEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction direction = ((Direction)cuttingBoardEntity.getBlockState().getValue(BirchCuttingBoardBlock.FACING)).getOpposite();
