...
import net.egorplaytv.create_and_food.block.custom.SpruceCuttingBoardBlock;
...
public class SpruceCuttingBoardRenderer implements BlockEntityRenderer<SpruceCuttingBoardBlockEntity> {
    public SpruceCuttingBoardRenderer(BlockEntityRendererProvider.Context context){
    }

    public void render(SpruceCuttingBoardBlockEntity cuttingBoardEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction direction = ((Direction)cuttingBoardEntity.getBlockState().getValue(SpruceCuttingBoardBlock.FACING)).getOpposite();
