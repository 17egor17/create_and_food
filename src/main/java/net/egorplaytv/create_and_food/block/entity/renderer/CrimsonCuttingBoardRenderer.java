...
import net.egorplaytv.create_and_food.block.custom.CrimsonCuttingBoardBlock;
...
public class CrimsonCuttingBoardRenderer implements BlockEntityRenderer<CrimsonCuttingBoardBlockEntity> {
    public CrimsonCuttingBoardRenderer(BlockEntityRendererProvider.Context context){
    }

    public void render(CrimsonCuttingBoardBlockEntity cuttingBoardEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction direction = ((Direction)cuttingBoardEntity.getBlockState().getValue(CrimsonCuttingBoardBlock.FACING)).getOpposite();
