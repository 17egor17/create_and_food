...
import net.egorplaytv.create_and_food.block.custom.DarkOakCuttingBoardBlock;
...
public class DarkOakCuttingBoardRenderer implements BlockEntityRenderer<DarkOakCuttingBoardBlockEntity> {
    public DarkOakCuttingBoardRenderer(BlockEntityRendererProvider.Context context){
    }

    public void render(DarkOakCuttingBoardBlockEntity cuttingBoardEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction direction = ((Direction)cuttingBoardEntity.getBlockState().getValue(DarkOakCuttingBoardBlock.FACING)).getOpposite();
