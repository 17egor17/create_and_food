...
import net.egorplaytv.create_and_food.block.custom.JungleCuttingBoardBlock;
...
public class JungleCuttingBoardRenderer implements BlockEntityRenderer<JungleCuttingBoardBlockEntity> {
    public JungleCuttingBoardRenderer(BlockEntityRendererProvider.Context context){
    }

    public void render(JungleCuttingBoardBlockEntity cuttingBoardEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction direction = ((Direction)cuttingBoardEntity.getBlockState().getValue(JungleCuttingBoardBlock.FACING)).getOpposite();
