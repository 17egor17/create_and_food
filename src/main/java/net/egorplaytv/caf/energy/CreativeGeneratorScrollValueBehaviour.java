...
public class CreativeGeneratorScrollValueBehaviour extends ScrollValueBehaviour {
    public CreativeGeneratorScrollValueBehaviour(Component label, SmartBlockEntity be, ValueBoxTransform slot) {
        super(label, be, slot);
    ...
    public ValueSettingsBoard createBoard(Player player, BlockHitResult hitResult) {
        ImmutableList<Component> rows = ImmutableList.of(TextUtils.getUnitsTranslation("dimperage"),
                TextUtils.getUnitsTranslation("kdimperage"));
    ...
    public String getClipboardKey() {
        return "Creative Generator Amperage";
    }
}
