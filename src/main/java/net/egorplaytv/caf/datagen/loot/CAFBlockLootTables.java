package net.egorplaytv.caf.datagen.loot;

import net.egorplaytv.caf.block.custom.RicePaniclesBlock;
import net.egorplaytv.caf.block.custom.RicePlantBlock;
import net.egorplaytv.caf.block.custom.RyePlantBlock;
...
public class CAFBlockLootTables extends BlockLoot {
    ...
    protected void addTables() {
        ...
        this.dropSelf(CS_CONTROLLER.get());
        this.dropSelf(CS_ENERGY_COMMUNICATION.get());
        this.dropSelf(CS_FLUID_COMMUNICATION.get());
