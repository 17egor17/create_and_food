...
public class ItemApplicationRecipeBuilder implements RecipeBuilder {
    ...
    public static ItemApplicationRecipeBuilder itemApplicationRecipe(ItemLike result, int count) {
        return new ItemApplicationRecipeBuilder(result, count);
    }

    public static ItemApplicationRecipeBuilder itemApplicationRecipe(ItemLike result) {
        return new ItemApplicationRecipeBuilder(result, 1);
    }

    public ItemApplicationRecipeBuilder addIngredient(TagKey<Item> tagIn) {
        return this.addIngredient(Ingredient.of(tagIn));
    }

    public ItemApplicationRecipeBuilder addIngredient(ItemLike itemIn) {
        return this.addIngredient(itemIn, 1);
    }

    public ItemApplicationRecipeBuilder addIngredient(ItemLike itemIn, int quantity) {
    ...
    public ItemApplicationRecipeBuilder addIngredient(Ingredient ingredientIn) {
        return this.addIngredient(ingredientIn, 1);
    }

    public ItemApplicationRecipeBuilder addIngredient(Ingredient ingredientIn, int quantity) {
        for(int i = 0; i < quantity; ++i) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return AllRecipeTypes.ITEM_APPLICATION.getSerializer();
        }
