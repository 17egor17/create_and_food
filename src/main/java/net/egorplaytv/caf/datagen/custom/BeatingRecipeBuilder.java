...
public class BeatingRecipeBuilder implements RecipeBuilder {
    ...
    public BeatingRecipeBuilder whenModLoaded(String modid) {
        withCondition(new ModLoadedCondition(modid));
        return this;
    }

    public BeatingRecipeBuilder whenModMissing(String modid) {
        withCondition(new NotCondition(new ModLoadedCondition(modid)));
        return this;
    }

    public BeatingRecipeBuilder withCondition(ICondition condition) {
