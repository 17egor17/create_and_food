...
//________________________Create and Food________________________\\
    public static final RegistryObject<MetalItem> RAW_IRON = registerItem("raw_iron",
            () -> new MetalItem(1538F, Type.RAW, Metals.IRON, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> IRON_INGOT = registerItem("iron_ingot",
            () -> new MetalItem(1538F, Type.INGOT, Metals.IRON, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> IRON_NUGGET = registerItem("iron_nugget",
            () -> new MetalItem(1538F, Type.NUGGET, Metals.IRON, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> RAW_COPPER = registerItem("raw_copper",
            () -> new MetalItem(1083.4F, Type.RAW, Metals.COPPER, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> COPPER_INGOT = registerItem("copper_ingot",
            () -> new MetalItem(1083.4F, Type.INGOT, Metals.COPPER, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> COPPER_NUGGET = registerItem("copper_nugget",
            () -> new MetalItem(1083.4F, Type.NUGGET, Metals.COPPER, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> RAW_GOLD = registerItem("raw_gold",
            () -> new MetalItem(1064.18F, Type.RAW, Metals.GOLD, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> GOLD_INGOT = registerItem("gold_ingot",
            () -> new MetalItem(1064.18F, Type.INGOT, Metals.GOLD, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> PIECE_OF_GOLD = registerItem("piece_of_gold",
            () -> new MetalItem(1064.18F, Type.PIECE, Metals.GOLD, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> GOLD_NUGGET = registerItem("gold_nugget",
            () -> new MetalItem(1064.18F, Type.NUGGET, Metals.GOLD, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> NETHERITE_INGOT = registerItem("netherite_ingot",
            () -> new MetalItem(3133F, Type.INGOT, Metals.NETHERITE, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> ALUMINUM_INGOT = registerItem("aluminum_ingot",
            () -> new DependentMetalItem(660F, Type.INGOT, Metals.ALUMINUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent));
    public static final RegistryObject<MetalItem> ALUMINUM_NUGGET = registerItem("aluminum_nugget",
            () -> new DependentMetalItem(660F, Type.NUGGET, Metals.ALUMINUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent));

    public static final RegistryObject<MetalItem> LEAD_INGOT = registerItem("lead_ingot",
            () -> new DependentMetalItem(327F, Type.INGOT, Metals.LEAD, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent, CreateAndFood.MEKIsPresent));
    public static final RegistryObject<MetalItem> LEAD_NUGGET = registerItem("lead_nugget",
            () -> new DependentMetalItem(327F, Type.NUGGET, Metals.LEAD, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent, CreateAndFood.MEKIsPresent));

    public static final RegistryObject<MetalItem> NICKEL_INGOT = registerItem("nickel_ingot",
            () -> new DependentMetalItem(1455F, Type.INGOT, Metals.NICKEL, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent));
    public static final RegistryObject<MetalItem> NICKEL_NUGGET = registerItem("nickel_nugget",
            () -> new DependentMetalItem(1455F, Type.NUGGET, Metals.NICKEL, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent));

    public static final RegistryObject<MetalItem> OSMIUM_INGOT = registerItem("osmium_ingot",
            () -> new DependentMetalItem(3030F, Type.INGOT, Metals.OSMIUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.MEKIsPresent));
    public static final RegistryObject<MetalItem> OSMIUM_NUGGET = registerItem("osmium_nugget",
            () -> new DependentMetalItem(3030F, Type.NUGGET, Metals.OSMIUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.MEKIsPresent));

    public static final RegistryObject<MetalItem> SILVER_INGOT = registerItem("silver_ingot",
            () -> new DependentMetalItem(961.93F, Type.INGOT, Metals.SILVER, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.THIsPresent, CreateAndFood.IEIsPresent));
    public static final RegistryObject<MetalItem> SILVER_NUGGET = registerItem("silver_nugget",
            () -> new DependentMetalItem(961.93F, Type.NUGGET, Metals.SILVER, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.THIsPresent, CreateAndFood.IEIsPresent));

    public static final RegistryObject<MetalItem> TIN_INGOT = registerItem("tin_ingot",
            () -> new DependentMetalItem(231.9F, Type.INGOT, Metals.TIN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.THIsPresent, CreateAndFood.MEKIsPresent));
    public static final RegistryObject<MetalItem> TIN_NUGGET = registerItem("tin_nugget",
            () -> new DependentMetalItem(231.9F, Type.NUGGET, Metals.TIN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.THIsPresent, CreateAndFood.MEKIsPresent));

    public static final RegistryObject<MetalItem> URANIUM_INGOT = registerItem("uranium_ingot",
            () -> new DependentMetalItem(1135F, Type.INGOT, Metals.URANIUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.MEKIsPresent, CreateAndFood.IEIsPresent));
    public static final RegistryObject<MetalItem> URANIUM_NUGGET = registerItem("uranium_nugget",
            () -> new DependentMetalItem(1135F, Type.NUGGET, Metals.URANIUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.MEKIsPresent, CreateAndFood.IEIsPresent));

    public static final RegistryObject<MetalItem> BRONZE_INGOT = registerItem("bronze_ingot",
            () -> new DependentMetalItem(1140F, Type.INGOT, Metals.BRONZE, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.MEKIsPresent, CreateAndFood.THIsPresent));
    public static final RegistryObject<MetalItem> BRONZE_NUGGET = registerItem("bronze_nugget",
            () -> new DependentMetalItem(1140F, Type.NUGGET, Metals.BRONZE, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.MEKIsPresent, CreateAndFood.THIsPresent));

    public static final RegistryObject<MetalItem> CONSTANTAN_INGOT = registerItem("constantan_ingot",
            () -> new DependentMetalItem(1260F, Type.INGOT, Metals.CONSTANTAN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent));
    public static final RegistryObject<MetalItem> CONSTANTAN_NUGGET = registerItem("constantan_nugget",
            () -> new DependentMetalItem(1260F, Type.NUGGET, Metals.CONSTANTAN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent));

    public static final RegistryObject<MetalItem> ELECTRUM_INGOT = registerItem("electrum_ingot",
            () -> new DependentMetalItem(960F, Type.INGOT, Metals.ELECTRUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent));
    public static final RegistryObject<MetalItem> ELECTRUM_NUGGET = registerItem("electrum_nugget",
            () -> new DependentMetalItem(960F, Type.NUGGET, Metals.ELECTRUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.IEIsPresent, CreateAndFood.THIsPresent));

    public static final RegistryObject<MetalItem> INVAR_INGOT = registerItem("invar_ingot",
            () -> new DependentMetalItem(1425F, Type.INGOT, Metals.INVAR, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.THIsPresent));
    public static final RegistryObject<MetalItem> INVAR_NUGGET = registerItem("invar_nugget",
            () -> new DependentMetalItem(1425F, Type.NUGGET, Metals.INVAR, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD),
                    CreateAndFood.THIsPresent));
    ...
    public static final RegistryObject<MetalItem> STEEL_NUGGET = registerItem("steel_nugget",
            () -> new MetalItem(1520F, Type.NUGGET, Metals.STEEL, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> STEEL_SHEET = registerItem("steel_sheet",
            () -> new MetalItem(1520F, Type.SHEET, Metals.STEEL, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> GLOWING_BRASS_INGOT = registerItem("glowing_brass_ingot",
            () -> new MetalItem(950F, Type.INGOT, Metals.BRASS, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> GLOWING_BRASS_NUGGET = registerItem("glowing_brass_nugget",
            () -> new MetalItem(950F, Type.NUGGET, Metals.BRASS, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> GLOWING_BRASS_SHEET = registerItem("glowing_brass_sheet",
            () -> new MetalItem(950F, Type.SHEET, Metals.BRASS, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> ALLOY_SOULS = registerItem("alloy_souls",
            () -> new MetalItem(1400F, Type.PIECE, Metals.ALLOY_SOULS, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> ALLOY_SOULS_INGOT = registerItem("alloy_souls_ingot",
            () -> new MetalItem(1400F, Type.INGOT, Metals.ALLOY_SOULS, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> ALLOY_SOULS_NUGGET = registerItem("alloy_souls_nugget",
            () -> new MetalItem(1400F, Type.NUGGET, Metals.ALLOY_SOULS, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    ...
    public static final RegistryObject<MetalItem> RAW_TANTALUM = registerItem("raw_tantalum",
            () -> new MetalItem(3020F, Type.RAW, Metals.TANTALUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> CRUSHED_RAW_TANTALUM = registerItem("crushed_raw_tantalum",
            () -> new MetalItem(3020F, Type.CRASHED_RAW, Metals.TANTALUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> TANTALUM_INGOT = registerItem("tantalum_ingot",
            () -> new MetalItem(3020F, Type.INGOT, Metals.TANTALUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> TANTALUM_NUGGET = registerItem("tantalum_nugget",
            () -> new MetalItem(3020F, Type.NUGGET, Metals.TANTALUM, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> RAW_TUNGSTEN = registerItem("raw_tungsten",
            () -> new MetalItem(3420F, Type.RAW, Metals.TUNGSTEN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> CRUSHED_RAW_TUNGSTEN = registerItem("crushed_raw_tungsten",
            () -> new MetalItem(3420F, Type.CRASHED_RAW, Metals.TUNGSTEN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> TUNGSTEN_INGOT = registerItem("tungsten_ingot",
            () -> new MetalItem(3420F, Type.INGOT, Metals.TUNGSTEN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> TUNGSTEN_NUGGET = registerItem("tungsten_nugget",
            () -> new MetalItem(3420F, Type.NUGGET, Metals.TUNGSTEN, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    ...
    public static final RegistryObject<MetalItem> IRON_COIN = registerItem("iron_coin",
            () -> new MetalItem(1538F, Type.COIN, Metals.IRON, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
    public static final RegistryObject<MetalItem> GOLDEN_COIN = registerItem("golden_coin",
            () -> new MetalItem(1064.18F, Type.COIN, Metals.GOLD, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> BROKEN_COPPER_COIN = registerItem("broken_copper_coin",
            () -> new MetalItem(1083.4F, Type.COIN, Metals.COPPER, new Item.Properties().tab(CreativeModeTab.TAB_SEARCH)));
    public static final RegistryObject<MetalItem> BROKEN_IRON_COIN = registerItem("broken_iron_coin",
            () -> new MetalItem(1538F, Type.COIN, Metals.IRON, new Item.Properties().tab(CreativeModeTab.TAB_SEARCH)));
    ...
    public static final RegistryObject<MetalItem> IRON_DUST = registerItem("iron_dust",
            () -> new MetalItem(1538F, Type.DUST, Metals.IRON, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));

    public static final RegistryObject<MetalItem> STEEL_DUST = registerItem("steel_dust",
            () -> new MetalItem(1520F, Type.DUST, Metals.STEEL, new Item.Properties().tab(CAFCreativeModeTab.CREATE_AND_FOOD)));
