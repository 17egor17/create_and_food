...
import net.egorplaytv.caf.block.custom.CAFCogWheelBlock;
...
public class CAFCogwheelBlockItem extends BlockItem {
    ...
    public CAFCogwheelBlockItem(CAFCogWheelBlock block, Properties builder) {
        super(block, builder);
        large = block.isLarge;

        placementHelperId = PlacementHelpers.register(large ? new CAFCogwheelBlockItem.LargeCogHelper() : new CAFCogwheelBlockItem.SmallCogHelper());
        integratedCogHelperId =
                PlacementHelpers.register(large ? new CAFCogwheelBlockItem.IntegratedLargeCogHelper() : new CAFCogwheelBlockItem.IntegratedSmallCogHelper());
    }
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            if (!ICogWheel.isLargeCog(state)) {
                ...
                for (Direction dir : directions) {
                    ...
                    if (!CAFCogWheelBlock.isValidCogwheelPosition(false, world, newPos, axis))
                        continue;
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            if (ICogWheel.isLargeCog(state)) {
                ...
                for (Direction dir : directions) {
                    ...
                    if (!CAFCogWheelBlock.isValidCogwheelPosition(true, world, newPos, dir.getAxis()))
                        continue;
    ...
    public abstract static class DiagonalCogHelper implements IPlacementHelper {
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            for (Direction dir : directions) {
                ...
                if (!CAFCogWheelBlock.isValidCogwheelPosition(ICogWheel.isLargeCog(state), world, newPos, axis))
                    continue;
    ...
    public static class IntegratedLargeCogHelper implements IPlacementHelper {
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            for (Direction d : directions) {
                ...
                if (!CAFCogWheelBlock.isValidCogwheelPosition(false, world, newPos, newAxis))
                    return PlacementOffset.fail();

                return PlacementOffset.success(newPos, s -> s.setValue(CAFCogWheelBlock.AXIS, newAxis));
            }
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            for (Direction d : directions) {
                ...
                return PlacementOffset.success()
                        .at(newPos)
                        .withTransform(s -> s.setValue(CAFCogWheelBlock.AXIS, newAxis));
            }
