...
import static net.egorplaytv.caf.block.entity.custom.TerminalBlockEntity.*;
            ...
            if (item != null && getMetals().get(item) != null && type != null && modId != null) {
                if (type.equals("metal")){
                    if (getMetals().get(item) >= 1) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.1"),
                                16, 41, 0xFF808080);
                    }
                    if (getMetals().get(item) >= 2) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.2"),
                                16, 51, 0xFF808080);
                    }
                    if (getMetals().get(item) >= 3) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.3",
                                        new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.1")),
                                16, 61, 0xFF808080);
                    }
                    if (getMetals().get(item) >= 4) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.4",
                                        new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.2")),
                                16, 71, 0xFF808080);
                    }
                    if (getMetals().get(item) >= 5) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.5",
                                        new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.3")),
                                16, 81, 0xFF808080);
                    }
                    if (getMetals().get(item) >= 6) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.6",
                                        new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.4")),
                                16, 91, 0xFF808080);
                    }
                    if (getMetals().get(item) == 7) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.7",
                ...
                if (type.equals("alloy")){
                    if (getMetals().get(item) >= 1) {
                        this.font.draw(poseStack, new TranslatableComponent("caf.sample.alloy.line.1"),
                                16, 41, 0xFF808080);
                    }
                    if (ingredientLines == 1) {
                        if (getMetals().get(item) >= 2) {
                            this.font.draw(poseStack, new TranslatableComponent("caf.sample.alloy.line.2",
                                            new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.1")),
                                    16, 51, 0xFF808080);
                        }
                        if (getMetals().get(item) >= 3) {
                            this.font.draw(poseStack, new TranslatableComponent("caf.sample.alloy.line.3",
                                            new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.2")),
                                    16, 61, 0xFF808080);
                        }
                        if (getMetals().get(item) >= 4) {
                            this.font.draw(poseStack, new TranslatableComponent("caf.sample.alloy.line.4",
                                            new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.3")),
                                    16, 71, 0xFF808080);
                        }
                        if (getMetals().get(item) >= 5) {
                            this.font.draw(poseStack, new TranslatableComponent("caf.sample.alloy.line.5",
                                            new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.4")),
                                    16, 81, 0xFF808080);
                        }
                        if (getMetals().get(item) >= 6) {
                            this.font.draw(poseStack, new TranslatableComponent("caf.sample.alloy.line.6"),
                                    16, 91, 0xFF808080);
                        }
                        if (getMetals().get(item) == 7) {
                            this.font.draw(poseStack, new TranslatableComponent("caf.sample.alloy.line.7",
                                            new TranslatableComponent(modId + ".sample." + itemOrTag + ".desc.line.5")),
                                    16, 101, 0xFF808080);
                        }
                ...
                if (type.equals("unknown")) {
                    this.font.draw(poseStack, new TranslatableComponent("caf.sample.unknown.desc"),
                            16, 41, 0xFF808080);
                    this.font.draw(poseStack, new TranslatableComponent( "caf.sample.alloy.line.2",
                                    new TranslatableComponent("caf.sample.unknown.desc")),
                            16, 51, 0xFF808080);
                    this.font.draw(poseStack, new TranslatableComponent("caf.sample.metal.line.3",
                                    new TranslatableComponent("caf.sample.unknown.desc")),
                            16, 61, 0xFF808080);
