...
@OnlyIn(Dist.CLIENT)
public class WorktableDoubleScreen extends AbstractContainerScreen<WorktableMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MOD_ID, "textures/gui/worktable_inventory.png");

    public WorktableDoubleScreen(WorktableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        this.blit(pPoseStack, x, y, 0, 80, 176, 80);
    ...
    protected void renderLabels(PoseStack poseStack, int pMouseX, int pMouseY) {
        this.font.draw(poseStack, new TranslatableComponent("ui.worktableDouble"), 4, 4, 0xFF808080);
