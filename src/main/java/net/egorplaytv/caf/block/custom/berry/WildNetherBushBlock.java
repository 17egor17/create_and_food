...
public class WildNetherBushBlock extends WildBerryBushBlock {
    private final NetherBushBlock.Type type;
    public WildNetherBushBlock(NetherBushBlock.Type type, Properties pProperties) {
        super(pProperties);
        this.type = type;
    }
