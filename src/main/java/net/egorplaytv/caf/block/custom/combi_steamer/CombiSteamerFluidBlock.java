...
public class CombiSteamerFluidBlock extends CombiSteamerBaseBlock implements ICommunicationBlock {
    ...
    private void shouldBeCompleted(BlockState pState, Level pLevel, BlockPos pPos) {
        BlockPos controllerPos1 = new BlockPos(pPos.getX() - 1, pPos.getY() - 1, pPos.getZ() - 1);
        BlockPos controllerPos2 = new BlockPos(pPos.getX() + 1, pPos.getY() - 1, pPos.getZ() + 1);
        BlockPos controllerPos3 = new BlockPos(pPos.getX() + 1, pPos.getY() - 1, pPos.getZ() - 1);
        BlockPos controllerPos4 = new BlockPos(pPos.getX() - 1, pPos.getY() - 1, pPos.getZ() + 1);
