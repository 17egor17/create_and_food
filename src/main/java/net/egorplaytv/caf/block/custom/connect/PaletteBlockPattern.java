...
import static net.egorplaytv.caf.block.custom.connect.PaletteBlockPartial.*;
import static net.egorplaytv.caf.block.custom.connect.PaletteBlockPattern.PatternNameType.*;
