...
import net.egorplaytv.caf.block.custom.AcaciaCuttingBoardBlock;
...
public class AcaciaCuttingBoardRenderer implements BlockEntityRenderer<AcaciaCuttingBoardBlockEntity> {
    public AcaciaCuttingBoardRenderer(BlockEntityRendererProvider.Context context){
    }

    public void render(AcaciaCuttingBoardBlockEntity cuttingBoardEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction direction = ((Direction)cuttingBoardEntity.getBlockState().getValue(AcaciaCuttingBoardBlock.FACING)).getOpposite();
