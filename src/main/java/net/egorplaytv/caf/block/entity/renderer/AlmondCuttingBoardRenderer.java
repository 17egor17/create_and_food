...
import net.egorplaytv.caf.block.custom.AlmondCuttingBoardBlock;
import net.egorplaytv.caf.block.entity.custom.AlmondCuttingBoardBlockEntity;
...
public class AlmondCuttingBoardRenderer implements BlockEntityRenderer<AlmondCuttingBoardBlockEntity> {
    public AlmondCuttingBoardRenderer(BlockEntityRendererProvider.Context context){
    }

    public void render(AlmondCuttingBoardBlockEntity cuttingBoardEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction direction = ((Direction)cuttingBoardEntity.getBlockState().getValue(AlmondCuttingBoardBlock.FACING)).getOpposite();
