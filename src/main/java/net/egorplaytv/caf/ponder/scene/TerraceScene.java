...
import net.egorplaytv.caf.block.custom.TerraceBlock;
import net.egorplaytv.caf.block.custom.TerraceStairsBlock;
...
public class TerraceScene {
    ...
    public static void terrace_all(SceneBuilder scene, SceneBuildingUtil util){
        ...
        Block oak_terrace = CAFBlocks.OAK_TERRACE.get();
        Block oak_terrace_stairs = CAFBlocks.OAK_TERRACE_STAIRS.get();
        Block acacia_terrace = CAFBlocks.ACACIA_TERRACE.get();
        Block acacia_terrace_stairs = CAFBlocks.ACACIA_TERRACE_STAIRS.get();
        Block almond_terrace = CAFBlocks.ALMOND_TERRACE.get();
        Block almond_terrace_stairs = CAFBlocks.ALMOND_TERRACE_STAIRS.get();
        Block birch_terrace = CAFBlocks.BIRCH_TERRACE.get();
        Block birch_terrace_stairs = CAFBlocks.BIRCH_TERRACE_STAIRS.get();
        Block crimson_terrace = CAFBlocks.CRIMSON_TERRACE.get();
        Block crimson_terrace_stairs = CAFBlocks.CRIMSON_TERRACE_STAIRS.get();
        Block jungle_terrace = CAFBlocks.JUNGLE_TERRACE.get();
        Block jungle_terrace_stairs = CAFBlocks.JUNGLE_TERRACE_STAIRS.get();
        Block dark_oak_terrace = CAFBlocks.DARK_OAK_TERRACE.get();
        Block dark_oak_terrace_stairs = CAFBlocks.DARK_OAK_TERRACE_STAIRS.get();
        Block spruce_terrace = CAFBlocks.SPRUCE_TERRACE.get();
        Block spruce_terrace_stairs = CAFBlocks.SPRUCE_TERRACE_STAIRS.get();
        Block warped_terrace = CAFBlocks.WARPED_TERRACE.get();
        Block warped_terrace_stairs = CAFBlocks.WARPED_TERRACE_STAIRS.get();
        scene.idle(20);
